...
int_fast32_t rx=4000000; // Starting frequency of VFO freq
int_fast32_t rx2=1; // temp variable to hold the updated frequency
int_fast32_t rxif=0; // IF freq, will be summed with vfo freq - rx variable 10002900
int_fast32_t rxbfo=9998000;  //BFO generator 5999950 6000000                        9999900   9999300
...
void checkCW(){
  ...
  if (inTx == 1 && cwTimeout < millis()){
    ...
    digitalWrite(TX_RX, 0);
    si5351.output_enable(SI5351_CLK0, 0);
    si5351.set_freq((100000L), SI5351_CLK0);
    si5351.drive_strength(SI5351_CLK0,SI5351_DRIVE_2MA);
    inTx = 0;
    cwTimeout = 0;
  }
...
// new
  ...
  si5351.set_freq(400000000L , SI5351_CLK1);
