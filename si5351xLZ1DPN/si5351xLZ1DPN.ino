...
Revision 12.0 - August 11, 2017  - SSB trx
...
int_fast32_t rxif=2000000; // IF freq, will be summed with vfo freq - rx variable 10002900
int_fast32_t rxbfo=11997000;  //BFO generator 5999950 6000000                        9999900   9999300  11997950
...
int BTNcheck = 0;
int BTNcheck2 = 0;
int BTNinc = 5; // set number of default band ---> (for 7MHz = 3)
...
// new
  ...
  si5351.set_freq((rx-rxbfo)*100L , SI5351_CLK0);
  // Set CLK0 to output txo vfo frequency
  si5351.set_freq((1000000L), SI5351_CLK1);
  si5351.output_enable(SI5351_CLK1, 0);
  // Set CLK2 to output bfo frequency
  si5351.set_freq(rxbfo*100L , SI5351_CLK2);
...
//	si5351.set_freq(((rx - rxbfo + rxRIT)*100LL), SI5351_CLK1);
  si5351.set_freq(((rx-rxbfo)*100LL), SI5351_CLK0);
